...
Scenario: Verify DELETE /api/part/category/parameters/{id}/ deletes a category parameter template
...
!-- Create category parameter template to delete
When I add request headers:
|name         |value           |
|Authorization|Token ${token}  |
|Content-Type |application/json|
...
!-- Delete the category parameter template
When I add request headers:
|name         |value          |
|Authorization|Token ${token} |

Scenario: Verify PATCH /api/company/part/manufacturer/{id}/ partially updates a manufacturer part
Meta:
@api
@apiVersion 479
@endpoint PATCH /api/company/part/manufacturer/{id}/
@responseCode 200
...
!-- Create a manufacturer part to partially update
...
When I execute HTTP PATCH request for resource with URL `${main-page-url}api/company/part/manufacturer/${mfgPartId}/`
Then response code is equal to `200`

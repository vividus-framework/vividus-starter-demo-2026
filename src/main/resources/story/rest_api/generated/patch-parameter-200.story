...
!-- Create a parameter to partially update
...
!-- Partially update only the note field
...
When I execute HTTP PATCH request for resource with URL `${main-page-url}api/parameter/${parameterId}/`
Then response code is equal to `200`

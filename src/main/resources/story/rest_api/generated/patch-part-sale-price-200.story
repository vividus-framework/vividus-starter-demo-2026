...
@api
@apiVersion 479
@endpoint PATCH /api/part/sale-price/{id}/
@responseCode 200

Scenario: Verify PATCH /api/part/sale-price/{id}/ partially updates a sale price break
...
When I execute HTTP PATCH request for resource with URL `${main-page-url}api/part/sale-price/${salePriceId}/`

Scenario: Verify POST /api/company/part/ creates a new supplier part
Meta:
@api
@apiVersion 479
@endpoint POST /api/company/part/
@responseCode 201
...
|Authorization|Token ${token}  |
|Content-Type |application/json|
Given request body: {"part": ${partId}, "supplier": ${supplierId}, "SKU": "${sku}", "description": "${description}"}
